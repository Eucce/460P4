...
public class Prog4 {
    ...
    *---------------------------------------------------------------------------*/
    ...
    private static void deletePackage() throws SQLException {
	    ...
	    if(checkDatesPackage(delPack,answer)) {
	    	if(checkRegistration(delPack,answer))
	    		deleteWhole(delPack);
	    	else
    ...
    private static boolean checkRegistration(String Package,ResultSet answer) throws SQLException {
    ...
    private static boolean checkDatesPackage(String Package,ResultSet answer) throws SQLException {
		boolean valid = true;
		...
		answer = statement.executeQuery(query1);
		while (answer.next()) {
			valid = checkDates(answer.getString(1),answer);
			if(valid == false) {
				break;
			}
		}
	...
	private static boolean checkDates(String course,ResultSet answer) throws SQLException {
    ...
    private static void updatePackage() throws SQLException {
	    ...
	    if(checkDates(result2,answer)) {
	    	if(checkRegistration(result2,answer)) {
		    	...
		    	if(result3.toLowerCase()=="add") {
			    	...
			    	updateHelper(result2,result4,"add",answer);
			    	...
			    	String result4 = scan.nextLine();
			    	updateHelper(result2,result4,"delete",answer);
		    	}
	    	}
	    	else
    ...
    private static void updateHelper(String packageID, String courseID, String str, ResultSet answer) throws SQLException {
		// TODO Auto-generated method stub
		if(str.equals("add")) {
	...
	private static void addPackage() throws SQLException {
    	ResultSet answer = null;
